using CliniCare.Application.InputModels.Scheduling;
...
{
    public class SchedulingValidator : AbstractValidator<CreateSchedulingInputModel>
    {
            ...
            IVeterinarianRepository veterinarianRepository)
        {
            ...
            .MustAsync(async (id, ct) => await _clientRepository.ExistsAsync(id))
